...
public class RegistrationPage extends BaseClass {
	...
	public void validateUserName(String UserName) {
		WebElementHelper.senKeys(userName, UserName);
	}
	
	public void validatepassword(String Password) {
		WebElementHelper.senKeys(password, Password);
	}
	
	public void validateconfirmPassword(String ConfPassword) {
		WebElementHelper.senKeys(confirmPassword, ConfPassword);
	}
